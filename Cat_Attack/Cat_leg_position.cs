...
namespace cat
{
    public class Cat_leg_position : MonoBehaviour
    {
        ...
        void Attack_Point(GameObject body, GameObject arm)
        {
            ...
            body.transform.position = new Vector3(Attack_position.position.x+20, cat_body_point.y, cat_body_point.z);
            arm.transform.position = new Vector3(Attack_position.position.x+35, cat_arm_point.y, cat_arm_point.z);
            print(Attack_position.position.x);
        }
